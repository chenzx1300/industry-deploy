...
// corp site (inovance.com/news) is a JS shell; cninfo API is the only reliable
// source. Governance/HR items only (same pattern as Nidec/Aisin).
...
c.news_url = 'https://www.inovance.com/news';
const N = [
