...
const NEV_MOTOR_COMPANIES = [
  ...
  { id: 'magna',          name: '麦格纳 Magna International',    region: 'intl', domain: 'magna.com',          monogram: '麦', monogram_color: '#16a34a', news_url: 'https://www.magna.com/newsroom/news?year=all&lang=en&page=1' },
  ...
  { id: 'inovance',       name: '汇川技术 Inovance',             region: 'cn',   domain: 'inovance.com',       monogram: '汇', monogram_color: '#4f46e5', news_url: 'https://www.inovance.com/portal/news/list?typeId=1' },
  { id: 'jjelectric',     name: '精进电动 JJ Electric',          region: 'cn',   domain: 'jjeglobal.com',      monogram: '精', monogram_color: '#0891b2', news_url: 'https://www.jjeglobal.com/news/2/' },
  { id: 'crrc-tel',       name: '中车时代电气 CRRC Times Electric', region: 'cn', domain: 'tec.crrczic.cc',    monogram: '车', monogram_color: '#65a30d', news_url: 'http://www.tec.crrczic.cc/1621.html' },
